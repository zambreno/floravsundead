...
typedef enum {ALWAYS_PRED=0, NEVER_PRED, READY_PRED, DAMAGE_PRED, EAT_PRED, HIT_PRED, SCORE_PRED, NUM_PRED_TYPES} PRED_TYPE;
...
/* Depth enum */
typedef enum {FRONT_DEPTH=0, FONT_DEPTH, PARTICLE_BOTTOM_DEPTH,
...
SCOREBOARD_DEPTH=60000, BACKGROUND_DEPTH, COURT_DEPTH, BACK_DEPTH} DEPTH_ENUM;
...
ZOMBIE_POLEVAULTER_INNERLEG_TOE, ZOMBIE_POLEVAULTER_INNERLEG_UPPER, ZOMBIE_POLEVAULTER_OUTERARM_LOWER, ZOMBIE_POLEVAULTER_OUTERARM_UPPER, ZOMBIE_POLEVAULTER_OUTERARM_UPPER2,  //35
 ...
 ZOMBIE_POLEVAULTER_POLE2, ZOMBIE_SCREENDOOR_1, ZOMBIE_SCREENDOOR_2, ZOMBIE_SCREENDOOR_3, NUM_ZOMBIE_SPRITES}                                                                  //37
 ZOMBIE_SPRITE_ENUM;
