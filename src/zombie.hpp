...
typedef enum {ZOMBIE_OUTERARM_LOWER_DEPTH = 0, ZOMBIE_OUTERARM_UPPER_DEPTH,ZOMBIE_OUTERARM_HAND_DEPTH, ZOMBIE_ACCESSORY_DEPTH, ZOMBIE_HEADFRONT_DEPTH, ZOMBIE_FRONTBODY_DEPTH, ZOMBIE_YETI_OUTERLEG_UPPER_DEPTH, ZOMBIE_YETI_OUTERLEG_LOWER_DEPTH, ZOMBIE_YETI_OUTERLEG_FOOT_DEPTH, ZOMBIEBODY_DEPTH,
...
ZOMBIE_INNERLEG_UPPER_DEPTH,  ZOMBIE_BACKBODY_DEPTH, ZOMBIE_INNERARM_LOWER_DEPTH, ZOMBIE_INNERARM_HAND_DEPTH, ZOMBIE_INNERARM_UPPER_DEPTH, ZOMBIE_YETI_INNERARM_HAND_DEPTH, ZOMBIE_SHADOW_DEPTH, ZOMBIE_DEPTH_RANGE} ZOMBIE_DEPTH_ENUM;
