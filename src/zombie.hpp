...
typedef enum {ZOMBIE_OUTERARM_LOWER_DEPTH = 0, ZOMBIE_OUTERARM_UPPER_DEPTH,ZOMBIE_OUTERARM_HAND_DEPTH, ZOMBIE_ACCESSORY_DEPTH, ZOMBIE_HEAD_ACCESSORY_DEPTH, ZOMBIE_HEAD_DEPTH, ZOMBIEBODY_DEPTH, ZOMBIEBODY2_DEPTH, ZOMBIE_OUTERLEG_UPPER_DEPTH, ZOMBIE_OUTERLEG_LOWER_DEPTH, ZOMBIE_OUTERLEG_FOOT_DEPTH, ZOMBIE_INNERLEG_FOOT_DEPTH, ZOMBIE_INNERLEG_LOWER_DEPTH,
