...
typedef enum {CHOMPER_RIGHT_FRONTLEAF_DEPTH = 0, PLANTHEAD_DEPTH, CHOMPER_TONGUE_DEPTH, CHOMPER_INSIDEMOUTH_DEPTH, FRONTLEAF_DEPTH, HEADLEAF_1_DEPTH, HEADLEAF_2_4_DEPTH, HEADLEAF_3,STEM_DEPTH, BACKLEAF_DEPTH, PLANT_OUTERARM_LOWER_DEPTH, PLANT_SHADOW_DEPTH, PLANT_DEPTH_RANGE} PLANT_DEPTH_ENUM;
