...
typedef enum {PEA_PROJECTILE=0, SNOW_PROJECTILE, PEA_PARTICLE, SNOW_PARTICLE, CHOMP_PROJECTILE, CHOMP_PARTICLE, SHOVEL_PARTICLE, WALLNUT_LITTLE_PARTICLE, WALLNUT_BIG_PARTICLE, PLANTING_PARTICLE,
