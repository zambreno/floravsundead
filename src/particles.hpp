...
REGULAR_ARM_PARTICLE, ZOMBIE_CONE_PARTICLE, ZOMBIE_BUCKET_PARTICLE, ZOMBIE_FOOTBALL_PARTICLE, FOOTBALL_ARM_PARTICLE, POLE_ARM_PARTICLE, REGULAR_HEAD_PARTICLE, POLE_HEAD_PARTICLE, FOOTBALL_HEAD_PARTICLE,
NEWS_HEAD_PARTICLE, ZOMBIE_NEWS_PARTICLE,
ZOMBIE_POLE_PARTICLE, ZOMBIE_SCREEN_PARTICLE, NUM_PARTICLE_TYPE} PARTICLE_TYPE;
