...
*/
    ...
    *****************************************************************************/
    ...
    //Head
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_HEAD, texCoords);
        x = 0;y = 100;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_JAW, texCoords);
        x = 21;y = 90;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_HEADFRONT_DEPTH);
    ...
    //Body
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_BODY, texCoords);
        x = 25;y = 20;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
    ...
    //Inner Arm
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERARM_UPPER, texCoords);
        x = 15;y = 60;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERARM_LOWER, texCoords);
        x = 17;y = 34;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        //Innerarm Hand
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERARM_HAND, texCoords);
        x = 26;y = 23;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_INNERARM_UPPER_DEPTH);
    ...
    //Outer Arm
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERARM_UPPER, texCoords);
        x = 70;y = 63;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERARM_LOWER, texCoords);
        x = 82;y = 22;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERARM_HAND, texCoords);
        x = 80;y = 4;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
    ...
    //Inner Leg
        getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERLEG_UPPER, texCoords);
        x = 35; y = 10;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERLEG_LOWER, texCoords);
        x = 35; y = -20;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_INNERLEG_FOOT, texCoords);
        x = 25; y = -30;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_INNERLEG_UPPER_DEPTH);
    ...
    //Outer Leg
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERLEG_UPPER, texCoords);
        x = 60; y = 0;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_FRONTBODY_DEPTH);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERLEG_LOWER, texCoords);
        x = 80; y = -30;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_FRONTBODY_DEPTH);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_YETI_OUTERLEG_FOOT, texCoords);
        x = 60; y = -44;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
