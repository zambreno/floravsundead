...
namespace fvu {
    ...
    *****************************************************************************/
    ...
    /*****************************************************************************
    * Function: Game::drawPaperZombie()
    * Description: Draws a Paper zombie.
    *****************************************************************************/

    void Game::drawPaperZombie() {
    ...
    //Head
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_HEAD_LOOK, texCoords);
        x = -10;y = 90;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_HEADFRONT_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[1]);
            glVertex3f(x+texCoords[4], y, ZOMBIE_HEADFRONT_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[3]);
            glVertex3f(x+texCoords[4], y+texCoords[5], ZOMBIE_HEADFRONT_DEPTH);
            glTexCoord2d(texCoords[0], texCoords[3]);
            glVertex3f(x, y+texCoords[5], ZOMBIE_HEADFRONT_DEPTH);
        glEnd();
        ...
        //Hair
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_HAIRPIECE, texCoords);
        x = -6; y = 120;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_HEADFRONT_DEPTH);
        ...
        //Glasses
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_GLASSES, texCoords);
        x = -11; y = 95;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_HEADFRONT_DEPTH);
    ...
    //Body
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_BODY, texCoords);
        x = 17;y = 36;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_FRONTBODY_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[1]);
            glVertex3f(x+texCoords[4], y, ZOMBIE_FRONTBODY_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[3]);
            glVertex3f(x+texCoords[4], y+texCoords[5], ZOMBIE_FRONTBODY_DEPTH);
            glTexCoord2d(texCoords[0], texCoords[3]);
            glVertex3f(x, y+texCoords[5], ZOMBIE_FRONTBODY_DEPTH);
        glEnd();

         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LOWERBODY1, texCoords);
        x = 35;y = 19;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LOWERBODY2, texCoords);
        x = 42;y = 18;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_BACKBODY_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[1]);
            glVertex3f(x+texCoords[4], y, ZOMBIE_BACKBODY_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[3]);
            glVertex3f(x+texCoords[4], y+texCoords[5], ZOMBIE_BACKBODY_DEPTH);
            glTexCoord2d(texCoords[0], texCoords[3]);
            glVertex3f(x, y+texCoords[5], ZOMBIE_BACKBODY_DEPTH);
        glEnd();
    //Inner Arm
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_RIGHTARM_UPPER, texCoords);
        x = -10;y = 60;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_RIGHTARM_LOWER, texCoords);
        x = -32;y = 54;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        //Draws the inner hand - Only after paper is destroyed
/*
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_HANDS2, texCoords);
        x = -52;y = 20;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_INNERARM_LOWER_DEPTH);
...
*/
    //Outer Arm
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LEFTARM_UPPER, texCoords);
        x = 40;y = 67;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_OUTERARM_UPPER_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[1]);
            glVertex3f(x+texCoords[4], y, ZOMBIE_OUTERARM_UPPER_DEPTH);
            glTexCoord2d(texCoords[2], texCoords[3]);
            glVertex3f(x+texCoords[4], y+texCoords[5], ZOMBIE_OUTERARM_UPPER_DEPTH);
            glTexCoord2d(texCoords[0], texCoords[3]);
            glVertex3f(x, y+texCoords[5], ZOMBIE_OUTERARM_UPPER_DEPTH);
        glEnd();

        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LEFTARM_LOWER, texCoords);
        x = 29;y = 43;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_HANDS, texCoords);
        x = -40;y = 41;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_OUTERARM_LOWER_DEPTH);
    ...
    //Paper
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_PAPER1, texCoords);
        x = -40;y = 30;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_OUTERARM_UPPER_DEPTH);
    ...
    //Inner Leg
        getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LEFTLEG_UPPER, texCoords);
        x = 70; y = 15;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LEFTLEG_LOWER, texCoords);
        x = 68; y = -15;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_RIGHTFOOT, texCoords);
        x = 23; y = -27;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
    ...
    //Outer Leg
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_RIGHTLEG_LOWER, texCoords);
        x = 33; y = -11;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
        ...
        glEnd();
         ...
         getTexCoords(TEX_ZOMBIES, ZOMBIE_PAPER_LEFTFOOT, texCoords);
        x = 48; y = -34;
        glBegin(GL_QUADS);
            glTexCoord2d(texCoords[0], texCoords[1]);
            glVertex3f(x, y, ZOMBIE_INNERLEG_FOOT_DEPTH);
