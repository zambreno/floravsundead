...
/* Object status enum */
typedef enum {OBJECT_STATUS_DEMO=0, OBJECT_STATUS_GAME, OBJECT_STATUS_ACTION, OBJECT_STATUS_WINNING, OBJECT_STATUS_SPECIAL, OBJECT_STATUS_INACTIVE} OBJECT_STATUS_ENUM;
